...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About Us | AllahCall</title>
        <meta name="description" content="Learn about AllahCall, our mission, vision, and the dedicated team working to spread authentic Islamic knowledge." />
      </Head>
      <main className=" ">
        <Navbar/>
        {/* Hero Section */}
