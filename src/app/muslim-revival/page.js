...
export default function MuslimRevivalPage() {
  ...
  return (
    <>
      <Head>
        <title>Muslim Revival | AllahCall</title>
        <meta name="description" content="Strengthen your faith and reconnect with Islamic teachings through our Muslim Revival programs." />
      </Head>
