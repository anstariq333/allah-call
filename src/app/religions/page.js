...
export default function ReligionsPage() {
  ...
  return (
    <>
      <Head>
        <title>World Religions | AllahCall</title>
        <meta name="description" content="Learn about world religions, their beliefs, and their connection to Islam on AllahCall." />
      </Head>
