...
export default function ChristianityPage() {
  ...
  return (
    <>
      <Head>
        <title>Understanding Christianity | AllahCall</title>
        <meta name="description" content="Learn about Christianity, its beliefs, and its relationship with Islam on AllahCall." />
      </Head>
