...
export default function OurServicesPage() {
  ...
  return (
    <>
      <Head>
        <title>Our Services | AllahCall</title>
        <meta name="description" content="Discover the comprehensive services and support AllahCall offers for your Islamic journey." />
      </Head>
