...
export default function JudaismPage() {
  ...
  return (
    <>
      <Head>
        <title>Understanding Judaism | AllahCall</title>
        <meta name="description" content="Explore the beliefs, history, and practices of Judaism and its connection to Islam." />
      </Head>
